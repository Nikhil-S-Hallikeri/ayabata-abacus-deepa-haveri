...
const Hero = () => {
    return (
        <div className="relative min-h-[90vh] flex items-center pt-30 overflow-hidden">
            {/* Background blobs */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1 text-left">
                    ...
                    >
                        <div className="flex gap-2 flex-wrap">
                            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-700 text-xs sm:text-sm font-semibold mb-3 sm:mb-6 border border-emerald-100 hover:bg-emerald-100">
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-6 italic">
                            Unlock Your Child's Potential at <span className="text-primary underline">{ACADEMY_INFO.name}</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-500 font-medium">
                            <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-primary"></span>
                                <span className="whitespace-nowrap">Aryabhata Vedic Maths</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-primary"></span>
                                <span className="whitespace-nowrap">Expert Math Coaching</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-primary"></span>
                                <span className="whitespace-nowrap">Safe Environment</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
                ...
                >
                    <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-4 border-[rgba(0,0,0,0.1)] h-[420px]">
                        <img
                            src={abacus}
