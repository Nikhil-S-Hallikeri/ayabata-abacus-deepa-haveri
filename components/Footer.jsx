                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                ...
                                <span>Near Fire Brigade, Hadi Basavannanagar, Hanagal Road, Haveri, Karnataka, India</span>
                            </li>
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:deepahamsini4@gmail.com" className="hover:text-primary text-sm break-all leading-tight">
                                    deepahamsini4@gmail.com
                                </a>
                            </li>
                        </ul>
                    </div>
